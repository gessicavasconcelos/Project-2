...
lines(density(df$AGE), # density plot
 ...
 col = "blue")
```
The histogram indicates that the age at which the crimes are comitted in DC seems to follow a bimodal distribution. Most of the crimes are comitted by people with ages between 22 and 24 years old. Then there is a deep 